            ...
            <div className="mt-10 pt-8 border-t border-slate-50 text-left">
              ...
              <ul className="space-y-2 text-[11px] text-slate-500 font-medium">
                <li className="flex items-start gap-2 italic">
                  ...
                  If the window closes instantly, check for a <strong>Pop-up Blocker</strong> in your browser's address bar.
                </li>
                <li className="flex items-start gap-2 italic">
                  <span className="text-orange-500">2.</span>
                  Ensure this domain is authorized in Firebase Settings.
                </li>
              </ul>
            </div>
          </div>
          <p className="text-center mt-6 text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">Personal Systematizer v1.2</p>
        </div>
      </div>
    );
  }
            ...
            <div className="lg:col-span-8">
              ...
              <div className="space-y-8">
                <div className="flex items-center justify-between mb-4 px-2">
                  <h2 className="text-xs font-black text-slate-400 uppercase tracking-widest">Global Library</h2>
                ...
                {recipes.length === 0 && !loading && dbStatus === 'online' && (
                  <div className="text-center py-32 bg-white rounded-[3rem] border-2 border-dashed border-slate-200 shadow-sm flex flex-col items-center">
                    ...
                    <h3 className="text-2xl font-black text-slate-900 tracking-tighter">Your library is empty</h3>
                    <p className="text-slate-400 mt-2 font-medium italic">Paste a recipe to begin systematizing.</p>
                  </div>
                )}
                ...
                <div className="mt-8 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
                  ...
                  <ul className="space-y-5">
                    <li className="flex items-center justify-between">
                      <span className="text-xs font-bold text-slate-600">Auth Status</span>
                      <span className="text-[10px] font-black text-green-600 bg-green-50 px-2 py-0.5 rounded uppercase">Verified</span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span className="text-xs font-bold text-slate-600">Database Cluster</span>
                    ...
                    <li className="flex items-center justify-between">
                      <span className="text-xs font-bold text-slate-600">Cognitive Engine</span>
